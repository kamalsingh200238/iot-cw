            ...
            <div class="flex gap-10 justify-between items-center">
                ...
                <div>
                    <button id="cart-button" class="py-2 px-2 rounded-md relative border-white border-3">
                        ...
                        <span id="cart-quantity" class="absolute right-0 top-0 translate-x-1/2 -translate-y-1/2 px-2 py-2 inline-block bg-yellow-100 rounded-full text-sky-950">0
                        </span>
                    </button>
                </div>
                <!-- Login button -->
    ...
    <section class="max-w-7xl mx-auto px-8">
        <form action="store.php" method="get">
            <div class="flex justify-center gap-5 pt-16">
                <input type="search" placeholder="Search for products...." name="query" class="max-w-xl rounded-md border-gray-300" />
                <button type="submit" class="py-2 px-5 mr-5 font-bold text-white rounded-md border-3 border-sky-950 bg-sky-950 hover:bg-sky-800 transition-all">
                    Search
                </button>
            </div>
        </form>
            ...
            <div class="grid grid-cols-4 gap-5 justify-items-center">
                ...
                while ($row = $result->fetch_assoc()) : ?>
                    <div class="flex flex-col gap-5 items-stretch p-5 bg-yellow-100 rounded-lg">
                        <img src="<?php echo "images/" . $row["id"] . ".jpg"; ?>" alt="white image" class="object-cover w-60 rounded-md aspect-square" />
                        <div class="px-2">
